...
class IndukrombelController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        <table>
            ...
            <tr>
                ...
                <td valign="top">
                    <div class="input-group">
                        <input type="text" class="form-control" name="ijazah_smp" value="'.$murid->ijazah_smp.'" placeholder="No. Ijazah SMP">
                        <input type="date" class="form-control" name="tanggal_ijazah_smp" value="'.$murid->tanggal_ijazah_smp.'">
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td valign="top">:</td>
                <td valign="top"><input type="text" class="form-control" name="alasan_meninggalkan" value="'.$murid->alasan_meninggalkan.'" placeholder="Tamat, Pindah, dll"></td>
            </tr>
            <tr>
                <td valign="top">18.</td>
                ...
                <td valign="top">
                    <div class="input-group">
                        <input type="text" class="form-control" name="no_ijazah_akhir" value="'.$murid->no_ijazah_akhir.'" placeholder="No. Ijazah">
                        <input type="date" class="form-control" name="tanggal_ijazah_akhir" value="'.$murid->tanggal_ijazah_akhir.'">
                    </div>
                </td>
            </tr>
            <tr>
    ...
    {
        $matapelajarans = \App\Models\Matapelajaran::orderBy('nama', 'asc')->get();
